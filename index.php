...
<html>
<head>
	<title>Магазин "Модная одежда" </title>
...
<body style="padding-top:10px;">
	<?php
		$products = array(
			'0' => array('id'=>1,'name'=> 'футболка', 'price'=>600),
			'1'=>array('id'=>2,'name'=>'трусы', 'price'=>200),
			'2'=>array('id'=>3,'name'=>'куртка', 'price' =>2000),
			'3'=>array('id'=>4,'name'=>'носки', 'price'=>150),
			'4'=>array('id'=>5,'name'=>'туфли (кожанные)','price'=>1400),
			'5'=>array('id'=>6,'name'=>'шапка (норковая)', 'price'=>10000));
